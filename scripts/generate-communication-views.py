...
def project_picture(model: dict[str, Any], index: dict[str, dict[str, Any]], view: dict[str, Any]) -> str:
    ...
    parts = [
        ...
        '<rect x="360" y="165" width="490" height="185" rx="18" class="platform" style="fill:#f8fafc;stroke:#aab7c8;stroke-width:1.5"/>',
        '<text x="385" y="195" style="font-size:15px;font-weight:700;fill:#607087;letter-spacing:1px">VEHICLE PLATFORM</text>',
        '<rect x="385" y="210" width="215" height="64" rx="10" class="chip blue"/>',
        lines_text(492.5, 248, ["Platform Communications"], "chip-title", "middle"),
        '<rect x="630" y="210" width="175" height="64" rx="10" class="chip blue"/>',
        lines_text(717.5, 248, ["Flight Avionics"], "chip-title", "middle"),
        '<rect x="385" y="290" width="145" height="48" rx="10" class="chip"/>',
        lines_text(457.5, 310, ["Airframe", "Structure"], "chip-title", "middle", 18),
        '<rect x="550" y="290" width="120" height="48" rx="10" class="chip"/>',
        lines_text(610, 319, ["Propulsion"], "chip-title", "middle"),
        '<rect x="690" y="290" width="115" height="48" rx="10" class="chip"/>',
        lines_text(747.5, 310, ["Electrical", "Power"], "chip-title", "middle", 18),
        '<rect x="500" y="405" width="350" height="130" rx="16" class="payload-black"/>',
        lines_text(675, 438, ["BLACK-BOX RELAY PAYLOAD"], "payload-title", "middle"),
        box(35, 190, 185, 86, display(index, "OP-010"), [], "blue"),
        lines_text(127.5, 255, ["Controls / monitors"], "small", "middle"),
        box(45, 415, 220, 110, display(index, "OP-001"), ["Remote-UAS command", "and return telemetry"], "white"),
        box(960, 415, 195, 110, display(index, "OP-003"), ["Receives command", "Returns telemetry"], "white"),
        arrow(220, 222, 385, 222, "Platform command", "blue", False, 206),
        arrow(385, 258, 220, 258, "Health / status", "blue", True, 282),
        arrow(265, 463, 500, 463, "Relayed command", "green", False, 443),
        '<line x1="500" y1="463" x2="850" y2="463" class="arrow green"/>',
        arrow(850, 463, 960, 463, kind="green"),
        arrow(960, 505, 850, 505, kind="green", dashed=True),
        '<line x1="850" y1="505" x2="500" y2="505" class="arrow green dashed"/>',
        arrow(500, 505, 265, 505, "Relayed telemetry", "green", True, 550),
        orthogonal_arrow(
            [(457.5, 338), (457.5, 372), (590, 372), (590, 405)],
            "Mechanical mount", label_position=(505, 367),
        ),
        orthogonal_arrow(
...
def physical_architecture(model: dict[str, Any], index: dict[str, dict[str, Any]], view: dict[str, Any]) -> str:
    ...
    parts = [
        ...
        box(347, 210, 205, 130, "Electrical Power", ["Stored energy", "Battery / bus / regulation"], "amber"),
        box(585, 210, 205, 130, "Flight Avionics", ["Stabilize and navigate", "Hold / health / recovery"], "blue"),
        box(110, 375, 275, 110, "Platform Communications", ["Separate carrier command", "Health / status return"], "blue"),
    ...
    parts.extend([
        arrow(790, 407, 875, 407, kind="amber"),
        lines_text(748, 365, ["regulated power"], "small", "middle"),
        '<line x1="790" y1="455" x2="875" y2="455" class="arrow"/>',
        lines_text(750, 510, ["mechanical retention"], "small", "middle"),
